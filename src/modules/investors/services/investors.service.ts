...
let INVESTOR_RECORDS: InvestorRecord[] = [
  {
    ...
    scopeIds: ['atlas-master-fund', 'tax-year-2026', 'northlight-pension'],
    commitment: '$85M',
    openQuestions: 1,
    requestCount: 3,
  ...
  },
  {
    ...
    scopeIds: ['atlas-master-fund', 'fed-state-compliance', 'tax-year-2026', 'meridian-family-office'],
    commitment: '$42M',
    openQuestions: 4,
    requestCount: 5,
  ...
  },
  {
    ...
    scopeIds: ['atlas-blocker-lux', 'atlas-master-fund', 'tax-year-2026', 'blue-harbor-feeder'],
    commitment: '$63M',
    openQuestions: 2,
    requestCount: 2,
  ...
  },
  {
    ...
    scopeIds: ['tax-year-2026', 'atlas-master-fund', 'alex-rivera'],
    commitment: '$8M',
    openQuestions: 3,
    requestCount: 2,
